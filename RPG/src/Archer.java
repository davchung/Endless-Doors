...
public class Archer extends Player {
	...
	public Attack getAttack() {
		...
		Attack arrow = new Arrow((int)this.getCX(), (int)this.getCY(), 10, 10, this.WIDTH, this.HEIGHT,RPGGame.lastR,RPGGame.lastD,15,200,this.getDamage()/2 + + RPGGame.getInventory().getTotalDmg(), "sprites/items/larger_arrow.png");
		canMove = RPGGame.ticks;
		return arrow;
	}
	public Attack getSpecial() {
		Grapple grapple = new Grapple((int)this.getCX(), (int)this.getCY(), 10,10, this.WIDTH, this.HEIGHT,RPGGame.lastR,RPGGame.lastD,12,200,this.getDamage(), "sprites/items/lavish_gold_sword.png");
		return grapple;
	}
