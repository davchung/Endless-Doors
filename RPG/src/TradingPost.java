...
public class TradingPost extends GameGUI {
	...
	public TradingPost() {
		...
		slot1 = new Weapon(weapons[GameObject.randInt(0, 3)], 100);
		slot2 = new Weapon(weapons[GameObject.randInt(4, 7)], 200);
		slot3 = new Weapon(weapons[GameObject.randInt(8, 11)], 300);
		slot4 = new Weapon(weapons[GameObject.randInt(12, 15)], 400);
		slot5 = new Weapon(weapons[GameObject.randInt(16, 18)], 500);
	}
	...
	public void draw(Graphics g) {
		...
		yVal += 35;
		g.drawString("Type 0 to check how much gold you have.", LEFT_MARGIN, yVal);
		yVal += 35;
